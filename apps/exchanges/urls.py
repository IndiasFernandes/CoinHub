...
from .views import exchange_list, exchange_detail, exchange_new, chart_view, update_market_coins, download_data_view, get_exchange_data, add_market, update_exchange_markets
...
urlpatterns = [
    ...
    path('update_exchange_markets/', update_exchange_markets, name='update_exchange_markets'),
]
