...
class Backtest(models.Model):
    ...
    start_date = models.DateTimeField(default=(timezone.now() - timedelta(days=30)), null=True, blank=True)
...
class Optimize(models.Model):
    ...
    created_at = models.DateTimeField(auto_now_add=True, blank=True, null=True)
    start_date = models.DateTimeField(default=(timezone.now() - timedelta(days=30)), blank=True, null=True)
